...
export const lightColors = {
  ...
  textSubtle: "#AA464B",
  disabled: "#E9EAEB",
  gradientPrimary: "linear-gradient(228.54deg, #EC7063 -13.69%, #CD5C5C 91.33%)",
  ...
  gradientBold: "linear-gradient(#53DEE9, #CD5C5C)",
};
...
export const darkColors = {
  ...
  textSubtle: "#F5B7B1",
  disabled: "#524B63",
  gradientPrimary: "linear-gradient(228.54deg, #EC7063 -13.69%, #9A6AFF 91.33%)",
