...
const GameBenefitsList = [
  ...
  },
  {
    ...
    desc: <Trans>PGSWAP FINANCE operates on 9 popular blockchains, welcoming developers from diverse ecosystems</Trans>,
      ...
      >
        <Flex pt={['0', '0', '0', '0', '24px']} alignItems="center" flexDirection="column" justifyContent="center">
          ...
          <Heading maxWidth={['745px']} textAlign="center" scale="xl" mb="32px">
            {t('Bring Your Game to Life on PGSWAP FINANCE')}
          </Heading>
