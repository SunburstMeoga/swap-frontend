...
const whitelist = [
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of Ex.Zone',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about Ex.Zone and more!',
  'Gaming Announcements',
  'Ex.Zone Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with Ex.Zone Now',
  'Bring Your Game to Life on Ex.Zone',
  ...
  'Ex.Zone operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'Ex.Zone Gaming Marketplace',
  'Play, Build and Connect on Ex.Zone',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
