...
const whitelist = [
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of PGSWAP FINANCE',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about PGSWAP FINANCE and more!',
  'Gaming Announcements',
  'PGSWAP FINANCE Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with PGSWAP FINANCE Now',
  'Bring Your Game to Life on PGSWAP FINANCE',
  ...
  'PGSWAP FINANCE operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'PGSWAP FINANCE Gaming Marketplace',
  'Play, Build and Connect on PGSWAP FINANCE',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
