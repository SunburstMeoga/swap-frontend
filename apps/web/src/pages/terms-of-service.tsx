...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">PGSWAP FINANCE Terms of Service</Text>
      ...
      <Text as="p">
        ...
        PGSWAP FINANCE protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. PGSWAP FINANCE does not control or operate any version of the Protocol on any blockchain
        ...
        PGSWAP FINANCE team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        PGSWAP FINANCE owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the PGSWAP FINANCE default token list and
        PGSWAP FINANCE expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on PGSWAP FINANCE.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by PGSWAP FINANCE, you will be solely responsible to
