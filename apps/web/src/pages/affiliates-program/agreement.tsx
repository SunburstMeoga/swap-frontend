  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          8.3 Any statements you make about PGSWAP FINANCE must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          14.1 PGSWAP FINANCE reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          14.2 PGSWAP FINANCE, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">14.3 PGSWAP FINANCE reserves the right to refuse service to anyone for any reason at any time.</Text>
