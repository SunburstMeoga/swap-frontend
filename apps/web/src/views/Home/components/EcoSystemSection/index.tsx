...
const useTradeBlockData = () => {
  ...
  const [onUSCitizenModalPresent] = useModal(
    <USCitizenConfirmModal title={t('Ex.Zone Perpetuals')} id={IdType.PERPETUALS} />,
    true,
    false,
  ...
  return useMemo(() => {
    return [
      ...
      },
      {
        ...
        description: t('Automate your Ex.Zone v3 liquidity'),
        ctaTitle: t('Stake Now'),
    ...
    return [
      {
        ...
        description: t('Play, Build and Connect on Ex.Zone'),
        ctaTitle: t('Play Now'),
