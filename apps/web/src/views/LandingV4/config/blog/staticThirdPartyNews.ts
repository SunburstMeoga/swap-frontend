...
export const staticThirdPartyNews: V4ArticleDataType[] = [
  {
    ...
    description:
      'Ex.Zone is the official partner of ETHGlobal London 2024. Hosting our first-ever hackathon featuring a $10,000 prize pool, where developers can showcase their creativity by building innovative hooks and win rewards.',
    createAt: '2024-03-15',
    categories: [],
    content: '',
    gamesCategories: [],
