...
export const wormHoleDarkTheme = {
  ...
  success: {
    '50': lightenColor('#DA251D', 0.9),
    '100': lightenColor('#DA251D', 0.8),
    '200': lightenColor('#DA251D', 0.7),
    '300': lightenColor('#DA251D', 0.6),
    '400': lightenColor('#DA251D', 0.5),
    '500': lightenColor('#DA251D', 0.4),
    '600': lightenColor('#DA251D', 0.3),
    '700': lightenColor('#DA251D', 0.2),
    '800': lightenColor('#DA251D', 0.1),
    '900': '#DA251D',
    A100: lightenColor('#DA251D', 0.8),
    A200: lightenColor('#DA251D', 0.7),
    A400: lightenColor('#DA251D', 0.5),
    A700: lightenColor('#DA251D', 0.2),
  },
  warning: {
...
export const wormHoleLightTheme = {
  ...
  text: { primary: '#280D5F', secondary: '#AA464B' },
  error: {
    '50': lightenColor('#ED4B9E', 0.9),
    '100': lightenColor('#ED4B9E', 0.8),
    '200': lightenColor('#ED4B9E', 0.7),
