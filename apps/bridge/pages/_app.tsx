    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="The most popular AMM on BSC! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by PGSWAP FINANCE), NFTs, and more, on a platform you can trust."
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="🥞 PGSWAP FINANCE - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>Bridge | PGSWAP FINANCE</title>
      </Head>
      <Providers>
        <ResetCSS />
        <GlobalStyle />
